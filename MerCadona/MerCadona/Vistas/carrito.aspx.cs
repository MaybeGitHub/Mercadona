...
namespace MerCadona.Vistas
{
    public partial class carrito : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //cliente.NIF = "09030912";
            //cliente.nombre = "Jesus";
            //cliente.apellido = "Salvador";
            //cliente.apellido2 = "Barcenilla";
            //cliente.email = "jesus.salvador.barcenilla@gmail.com";            
            ...
            if (IsPostBack)
            {
                ...
                {
                    info.Text += "Key: " + key + "          Value: " + Request.Params[key] + "\n";
                    ...
                    {                        
                        Response.Redirect("~/Vistas/formalizar.aspx");
                    }
                    ...
                    if (key.Contains("BotonModDatos"))
                    {
                        ...
                        Response.Redirect("~/Vistas/altacliente.aspx");
                    }
            ...
            {
                HttpCookie miCookie = new HttpCookie("Cliente", cliente.NIF);
