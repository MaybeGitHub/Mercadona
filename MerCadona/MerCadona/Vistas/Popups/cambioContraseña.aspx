    ...
    <form id="form1" runat="server">
        <asp:Panel runat="server" Width="100%" Height="100%">
            <asp:Table runat="server" BorderColor="DarkGreen" BorderWidth="1px" Width="100%" CellPadding="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
                        <asp:Label runat="server" Text="Introduzca el Nº Identificación (DNI, NIF, CIF, NIE) y pulse enviar. Se le enviará un correo electrónico al correo asociado para que pueda generar una nueva contraseña." Width="100%"></asp:Label>                        
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:TextBox runat="server" ID="text_NIF" Width="80%"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <asp:CustomValidator ID="cv_Numero" runat="server" OnServerValidate="cv_Numero_ServerValidate" ErrorMessage="No existe un cliente con este numero de identificacion" ForeColor="DarkRed" Font-Size="Small"></asp:CustomValidator>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
