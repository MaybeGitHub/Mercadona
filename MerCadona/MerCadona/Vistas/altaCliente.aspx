    ...
    <form id="form1" runat="server">
        <asp:Panel runat="server">
            <asp:Table runat="server" Width="100%" BorderColor="DarkGreen" BorderWidth="1px" CellPadding="5" CellSpacing="0">
                ...
                <asp:TableRow HorizontalAlign="Center">
                    <asp:TableCell Width="30%">
                        <asp:TextBox runat="server" ID="text_TipoID" Width="60%"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell Width="30%">
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="3" HorizontalAlign="Right">
                        ...
                        <asp:Button runat="server" PostBackUrl="~/Vistas/index.aspx" Text="CERRAR" ForeColor="DarkGreen" BackColor="White" BorderColor="DarkGreen" BorderWidth="1px" style="margin-left:10px"/>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </asp:Panel>
