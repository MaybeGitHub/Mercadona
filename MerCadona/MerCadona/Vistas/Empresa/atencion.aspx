    ...
    <asp:Table runat="server" HorizontalAlign="Center" CellPadding="5" BorderColor="DarkGreen" BorderWidth="1px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell HorizontalAlign="Right">
                <asp:Label ID="label_ErrorAsunto"  Visible="false" runat="server" ForeColor="DarkRed" Font-Size="Small" Text="Hay que selecionar una opcion" style="margin-right:10px"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell HorizontalAlign="Right">
                <asp:Label ID="label_ErrorMensaje" Visible="false" Text="Este campo no puede estar vacio" runat="server" ForeColor="DarkRed" Font-Size="Small" style="margin-right:10px"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell ColumnSpan="2">
                <asp:Label runat="server" Text="Datos de contacto (Si desea respuesta ha de rellenar al menos uno de los dos campos):" style="margin-left:20px"></asp:Label>
                                           ...
                                           </asp:TableRow><asp:TableRow HorizontalAlign="Right">
            <asp:TableCell>                
            ...
            <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                <asp:Button runat="server" ID="button_Consulta" Text="Enviar Consulta"/>
            </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell>
