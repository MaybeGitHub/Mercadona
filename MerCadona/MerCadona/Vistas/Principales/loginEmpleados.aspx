            ...
            <asp:Table runat="server" Width="20%" Height="25%" BorderColor="DarkGreen" BorderWidth="1px" HorizontalAlign="Center">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
                        <asp:DropDownList Width="200px" runat="server" ID="list_Tipos"></asp:DropDownList>
                        <br /><asp:Label runat="server" ID="label_Error" ForeColor="DarkRed" Font-Size="Smaller" Visible="false" Text="Datos erroneos"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>                
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        <asp:Button runat="server" ID="button_Salir" Text="Volver" PostBackUrl="~/Vistas/Principales/index.aspx" style="margin-left:20px"/>
                    </asp:TableCell>
                    <asp:TableCell HorizontalAlign="Right">
                        <asp:Button runat="server" ID="button_Entrar" Text="Entrar" style="margin-right:20px"/>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </asp:Panel>
