        ...
        <form runat="server">
                ...
                <asp:Table runat="server" HorizontalAlign="Right">
                    <asp:TableRow>
                        <asp:TableCell>
                            ...
                            <asp:Label runat="server" Font-Size="X-Large">|</asp:Label>
                            <asp:LinkButton ID="link_Empleado" runat="server" PostBackUrl="~/Vistas/Principales/loginEmpleados.aspx" OnClick="link_Empleado_Click">Soy Empleado</asp:LinkButton>                                                                                        
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </asp:Panel>
            <asp:Panel runat="server" HorizontalAlign="Center" ID="contenido" Width="100%">
                ...
                <asp:Table runat="server" ID="opciones" Width="100%">
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:ImageButton runat="server" ID="imgButton_Compra" ImageUrl="~/imagenes/imagenes_Inicio/index_Compra.JPG" PostBackUrl="~/Vistas/Principales/entrada.aspx"/>
                        </asp:TableCell>
                        <asp:TableCell>
                        ...
                        <asp:TableCell>
                            <asp:ImageButton runat="server" ID="imgButton_Empresa" ImageUrl="~/imagenes/imagenes_Inicio/index_corp.JPG" PostBackUrl="~/Vistas/Empresa/menu.aspx"/>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
