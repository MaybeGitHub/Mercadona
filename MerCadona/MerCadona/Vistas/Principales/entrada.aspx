...
<body>
    ...
    <asp:Table runat="server" Width="100%">
        <asp:TableRow>
            <asp:TableCell>
                <asp:LinkButton runat="server" ID="link_Registro" Text="Registrarse como Cliente" ForeColor="Black"></asp:LinkButton>
            </asp:TableCell>
    ...
    <asp:Panel runat="server" HorizontalAlign="Center"><asp:Label runat="server" Text="Usted podrá conocer si damos servicio en su domicilio registrándose como cliente, consultando a través del siguiente formulario de " ForeColor="DarkRed"></asp:Label> 
        <asp:LinkButton runat="server" Text="Atención al Cliente " PostBackUrl="~/Vistas/Empresa/atencion.aspx" ForeColor="BlueViolet"></asp:LinkButton>
