            ...
            <asp:Table runat="server" BorderColor="DarkGreen" BorderWidth="1px" Width="100%" CellPadding="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Right" ColumnSpan="2">
                        ...
                        <asp:Button runat="server" ID="buton_Cerrar" Text="CERRAR" ForeColor="DarkGreen" BackColor="White" BorderColor="DarkGreen" BorderWidth="1px" style="margin-left:5px" PostBackUrl="~/Vistas/index.aspx"/>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </asp:Panel>
